 ...
 *
 * @param db
 * @param filename can also be "stdin.tsv"
...
/**
 * Assumes quotes are not special i.e. no embedded tabs or newline
 */
static int indexLines (struct DB *db) {
    int count = 0;
    size_t i = 0;
...
/**
 * @brief Convert from VALUES layout e.g. ('a',1),('b',2) to tsv in memory
 *
 * @param db
 * @param input
