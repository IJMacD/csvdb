...
DBGCFLAGS = -g -O0 -DDEBUG -DJSON_NULL -DJSON_BOOL -DCOMPILE_CALENDAR -DCOMPILE_SEQUENCE -DCOMPILE_CSV_MMAP -DCOMPILE_TSV -DCOMPILE_COL
...
RELCFLAGS = -O3 -DNDEBUG -DJSON_NULL -DJSON_BOOL -DCOMPILE_CALENDAR -DCOMPILE_SEQUENCE -DCOMPILE_CSV_MMAP -DCOMPILE_TSV -DCOMPILE_COL
